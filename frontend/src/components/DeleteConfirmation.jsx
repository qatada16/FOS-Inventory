export const DeleteConfirmation = ({ item, onConfirm, onCancel }) => {
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="relative max-w-md w-full rounded-xl overflow-hidden bg-gradient-to-br from-[#1a2f36] to-[#284952] border border-[#95CFAB]/20 p-6">
        <div className="mb-6">
          <h3 className="text-xl font-bold text-[#95CFAB] mb-2">Confirm Deletion</h3>
          <p className="text-[#95CFAB]/80">Are you sure you want to delete {item.name} ({item.code})? This action cannot be undone.</p>
        </div>
